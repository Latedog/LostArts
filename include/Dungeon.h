...
public:
	...
	void trapEncounter(int x, int y, Coords &playerCoords = Coords());
	...
	*       It is currently public to allow MonsterTransform to call it
...
protected:
	/* Protected to prevent direct creation of Dungeons. */
