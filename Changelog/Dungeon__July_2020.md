...
- Most traps now require a a Dungeon in its constructor so that the sprites can be created. Now almost all traps are no longer created in the renderDungeon funtion in GUI.
